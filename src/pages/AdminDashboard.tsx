...
const AdminDashboard = () => {
  ...
  const handleDelete = async (id: string, type: 'event' | 'sermon' | 'document') => {
    if (!window.confirm(`Are you sure you want to delete this ${type}?`)) return;

    const { error } = await supabase
      .from(type === 'event' ? 'events' : type === 'sermon' ? 'sermons' : 'documents')
      .delete()
      .eq('id', id);
  ...
  const handleStatsSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const statsData = {
      ...
      outreaches_conducted: parseInt(formData.get('outreaches_conducted') as string),
      locals_reached: parseInt(formData.get('locals_reached') as string),
      communities_reached: parseInt(formData.get('communities_reached') as string),
      souls_won: parseInt(formData.get('souls_won') as string),
      rededication_commitments: parseInt(formData.get('rededication_commitments') as string),
      medical_beneficiaries: parseInt(formData.get('medical_beneficiaries') as string),
      welfare_beneficiaries: parseInt(formData.get('welfare_beneficiaries') as string),
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-2xl">{statistics.outreaches_conducted}</p>
                  </div>
                  <div>
                  ...
                  <div>
                    ...
                    <p className="text-2xl">{statistics.rededication_commitments}</p>
                  </div>
                  <div>
                    <p className="font-medium">Medical Beneficiaries</p>
                    <p className="text-2xl">{statistics.medical_beneficiaries}</p>
                  </div>
                  <div>
                    <p className="font-medium">Welfare Beneficiaries</p>
                    <p className="text-2xl">{statistics.welfare_beneficiaries}</p>
                  </div>
                </div>
            ...
            <form onSubmit={handleSermonSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="datetime-local"
                  name="date"
                  defaultValue={editingSermon?.date ? new Date(editingSermon.date).toISOString().slice(0, 16) : ''}
                  required
                  className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full p-6">
            ...
            <form onSubmit={handleStatsSubmit} className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Outreaches Conducted</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Locals Reached</label>
                  <input
                    type="number"
                    name="locals_reached"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Communities Reached</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Souls Won</label>
                  <input
                    type="number"
                    name="souls_won"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Rededication Commitments</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Medical Beneficiaries</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700">Welfare Beneficiaries</label>
                  <input
                    type="number"

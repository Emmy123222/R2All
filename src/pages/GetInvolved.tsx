      ...
      <section className="relative h-[400px]">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            ...
            <p className="text-xl">
              Join us in spreading the Gospel and making a difference in people's lives.
            </p>
          </div>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <p className="text-lg text-gray-600 mb-8">
                Support our mission work through your generous donations. Your contribution helps us
                reach more people with the Gospel message.
              </p>
              ...
              <div className="mb-8">
                ...
                <div className="space-y-2">
                  <p>
                    <span className="font-medium">Bank Name:</span> First Gospel Bank
                  </p>
                  <p>
                    <span className="font-medium">Account Name:</span> Gospel Mission
                  </p>
                  <p>
              ...
              <button
                onClick={() => toast.error('Payment gateway integration coming soon!')}
